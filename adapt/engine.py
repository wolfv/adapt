...
class IntentDeterminationEngine(pyee.EventEmitter):
    ...
    def __init__(self, tokenizer=None, trie=None):
        ...
        self.special_tagger = []
        self.tagger = EntityTagger(self.trie, self.tokenizer, self.regular_expressions_entities, self.special_tagger)
        self.intent_parsers = []
    ...
    def register_special_tagger(self, tagger):
        """
        A regular expression making use of python named group expressions.
        ...
        self.special_tagger.append(tagger)
